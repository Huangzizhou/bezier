...
template<>
void initMatricesT<1, 1, 2> (Matrix<Interval> &l2b, std::pair<Matrix<Interval>, Matrix<Interval>> &tsd, std::array<Matrix<Interval>, 4> &ssd) {
	l2b.fill({4, 0, 0, 1, 1, 1, 1, 1, 1, 2, 2, 1, 1, 3, 3, 1, 1});
	tsd.first.fill({4, 0, 0, 1, 1, 1, 0, 1, 2, 1, 1, 1, 2, 2, 2, 1, 1, 3, 2, 1, 2, 3, 3, 1, 2});
	tsd.second.fill({4, 0, 0, 1, 2, 0, 1, 1, 2, 1, 1, 1, 1, 2, 2, 1, 2, 2, 3, 1, 2, 3, 3, 1, 1});
